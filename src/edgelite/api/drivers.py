...
async def get_driver_config_schema(
    ...
    schemas = {
        ...
        "http_webhook": {
            ...
            "fields": [
                {"name": "path", "type": "string", "label": "Webhook路径", "description": "数据接收URL路径，如 /webhook/data", "default": "/webhook/data", "required": True},
                {"name": "secret", "type": "string", "label": "签名密钥", "description": "用于验证请求签名的密钥，留空则不验证"},
