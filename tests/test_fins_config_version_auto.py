"""自动生成测试 - src/edgelite/drivers/fins_config_version.py"""
# AUTO-GENERATED
import pytest
import sys
...
try:
    from src.edgelite.drivers.fins_config_version import *  # noqa
    _OK = True
except ImportError as _e:
    _OK = False; _ERR = str(_e)

class TestFinsConfigVersionAuto:
    ...
    def test_diff_versions_callable(self):
        ...
        import asyncio
        asyncio.get_event_loop().run_until_complete(diff_versions(1, "", ""))
