...
const driverFieldI18nMap: Record<string, Record<string, string>> = {
  ...
  'Video(GB28181)': {
    ...
    'PyGBSentry Address': 'driverField.video-gb28181.pygbsentryAddr',
    'PyGBSentry service address': 'driverField.video-gb28181.pygbsentryAddrDesc',
    'Username': 'driverField.video-gb28181.username',
    'SIP authentication username': 'driverField.video-gb28181.usernameDesc',
    'Password': 'driverField.video-gb28181.password',
    'SIP authentication password': 'driverField.video-gb28181.passwordDesc',
    'Reconnect Interval (s)': 'driverField.video-gb28181.reconnectInterval',
    'Seconds between reconnection attempts': 'driverField.video-gb28181.reconnectIntervalDesc',
  },
  'Simulator': {
  ...
  'BACnet/IP': {
    'BACnet/IP building automation protocol, supports HVAC/Lighting/Access control': 'driverField.bacnet.desc',
    'BACnet Device IP': 'driverField.bacnet.host',
    'BACnet device or broadcast address': 'driverField.bacnet.hostDesc',
    'Port': 'driverField.bacnet.port',
    'BACnet/IP port (default 47808)': 'driverField.bacnet.portDesc',
    'Device Instance': 'driverField.bacnet.deviceInstance',
    'BACnet device instance number': 'driverField.bacnet.deviceInstanceDesc',
    'Timeout (s)': 'driverField.bacnet.timeout',
    'Communication timeout in seconds': 'driverField.bacnet.timeoutDesc',
    'Enable COV Subscription': 'driverField.bacnet.enableCov',
    'Enable Change-of-Value subscription for real-time updates': 'driverField.bacnet.enableCovDesc',
    'COV Lifetime (s)': 'driverField.bacnet.covLifetime',
    'COV subscription lifetime in seconds (0=permanent)': 'driverField.bacnet.covLifetimeDesc',
  },
  'KNXnet/IP': {
    'KNX building automation protocol for HVAC/Lighting/Control': 'driverField.knx.desc',
    'KNX Gateway IP': 'driverField.knx.gatewayHost',
    'KNXnet/IP gateway IP address': 'driverField.knx.gatewayHostDesc',
    'Gateway Port': 'driverField.knx.gatewayPort',
    'KNXnet/IP port (default 3671)': 'driverField.knx.gatewayPortDesc',
    'Local Port': 'driverField.knx.localPort',
    'Local UDP port (0=random)': 'driverField.knx.localPortDesc',
    'Enable Event Subscription': 'driverField.knx.enableEvents',
    'Enable group address event subscription for real-time updates': 'driverField.knx.enableEventsDesc',
  },
  'Profinet DCP': {
    'Profinet industrial Ethernet protocol with Snap7 integration for IO data exchange': 'driverField.profinet.desc',
    'Interface IP': 'driverField.profinet.interfaceIp',
    'Local network interface IP for sending broadcasts': 'driverField.profinet.interfaceIpDesc',
    'Port': 'driverField.profinet.port',
    'Profinet DCP port (default 34964)': 'driverField.profinet.portDesc',
    'Enable Snap7 IO': 'driverField.profinet.enableSnap7',
    'Enable Snap7 for IO data exchange (requires python-snap7)': 'driverField.profinet.enableSnap7Desc',
    'Snap7 PLC IP': 'driverField.profinet.snap7PlcIp',
    'PLC IP for Snap7 connection (when Snap7 enabled)': 'driverField.profinet.snap7PlcIpDesc',
    'Snap7 Rack': 'driverField.profinet.snap7Rack',
    'PLC rack number for Snap7': 'driverField.profinet.snap7RackDesc',
    'Snap7 Slot': 'driverField.profinet.snap7Slot',
    'PLC slot number for Snap7': 'driverField.profinet.snap7SlotDesc',
  },
  'EtherCAT': {
    'EtherCAT high-speed industrial Ethernet for motion control and distributed IO (SOEM integrated)': 'driverField.ethercat.desc',
    'Network Interface': 'driverField.ethercat.iface',
    'EtherCAT network interface (e.g. eth0, ens1f0)': 'driverField.ethercat.ifaceDesc',
    'Timeout (ms)': 'driverField.ethercat.timeout',
    'Operation timeout in milliseconds': 'driverField.ethercat.timeoutDesc',
    'Enable DC Sync': 'driverField.ethercat.enableDc',
    'Enable Distributed Clock synchronization': 'driverField.ethercat.enableDcDesc',
  },
  'Modbus Slave': {
