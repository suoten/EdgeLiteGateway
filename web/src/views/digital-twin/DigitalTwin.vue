...
.scene-btn {
  ...
  color: #90a4ae; transition: all 0.2s; white-space: nowrap;
}
...
.minimap-title { font-size: 9px; color: #607d8b; text-align: center; margin-bottom: 2px; }
...
.device-list-toggle {
  ...
  background: rgba(10, 15, 26, 0.85); backdrop-filter: blur(12px);
  border: 1px solid rgba(79, 195, 247, 0.15); border-radius: 8px;
  color: #90a4ae; font-size: 13px; cursor: pointer; z-index: 10; transition: all 0.2s;
}
