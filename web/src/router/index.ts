  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'system/ai-model', name: 'AiModel', component: () => import('@/views/system/AiModel.vue'), meta: { requiredRole: 'admin' } },
        { path: 'system/notify', name: 'NotifyConfig', component: () => import('@/views/system/NotifyConfig.vue'), meta: { requiredRole: 'admin' } },
        { path: 'system/integration', name: 'Integration', component: () => import('@/views/system/Integration.vue'), meta: { requiredRole: 'admin' } },
        { path: 'system/debug', name: 'ProtocolDebug', component: () => import('@/views/system/ProtocolDebug.vue'), meta: { requiredRole: 'admin' } },
